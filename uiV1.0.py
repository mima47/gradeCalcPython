...
queryButton = Button(root,text='Make \n Query',height=9, command=query).grid(row=0,column=3)
...
currMonthButton = Button(root, text='Current \n Month',command=currMonth)
currMonthButton.grid(row=1,column=3)

lastMonthButton = Button(root, text='Last \n Month',command=lastMonth)
lastMonthButton.grid(row=2,column=3)
